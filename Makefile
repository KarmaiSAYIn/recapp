objects = main.o Engine.o Game.o Graphics.o Keyboard.o Mouse.o MainWindow.o CoordinateTransformer.o Entity.o Camera.o Drawable.o Time.o IndexedTriangleList.o SceneCube.o SceneDoubleCube.o
...
SceneCube.o : SceneCube.cpp SceneCube.h
	$(CC) -c -o SceneCube.o SceneCube.cpp $(build_flags)
SceneDoubleCube.o : SceneDoubleCube.cpp SceneDoubleCube.h
	$(CC) -c -o SceneDoubleCube.o SceneDoubleCube.cpp $(build_flags)
